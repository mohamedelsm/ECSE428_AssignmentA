...
When I select a textbook listing I would like to trade for
And I click the "Request to Trade" button
...
When I select a textbook listing I have already requested to trade for
And I click the "Request to Trade" button
