...
When I navigate to the page for editing my listing
And I make changes to the listing information, such as the title, author, price, or condition
...
And I make changes to the listing information
